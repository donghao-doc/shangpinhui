          ...
          <div class="tab-pane active">
            ...
            <ul class="goodsList">
              <li>
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/detail/part01.png" alt="part01">
                  </div>
              ...
              <li>
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/detail/part02.png" alt="part02">
                  </div>
                  <div class="attr">
              ...
              <li>
                <div class="list-wrap">
                  <div class="p-img">
                    <img src="@/assets/detail/part03.png" alt="part03">
                  </div>
                  <div class="attr">
                    <em>Apple苹果iPhone 6s (A1699)</em>
                  </div>
      ...
      <div class="detail">
        <div class="fitting">
          ...
          <div class="good-suits">
            <div class="master">
              <img src="@/assets/detail/l-m01.png" alt="l-m01">
              <p>￥5299</p>
              <i>+</i>
            </div>
            <ul class="suits">
              <li class="suitsItem">
                <img src="@/assets/detail/dp01.png" alt="dp01">
                <p>Feless费勒斯VR</p>
                <label>
              ...
              <li class="suitsItem">
                <img src="@/assets/detail/dp02.png" alt="dp02">
                <p>Feless费勒斯VR</p>
                <label>
              ...
              <li class="suitsItem">
                <img src="@/assets/detail/dp03.png" alt="dp03">
                <p>Feless费勒斯VR</p>
                <label>
              ...
              <li class="suitsItem">
                <img src="@/assets/detail/dp04.png" alt="dp04">
                <p>Feless费勒斯VR</p>
                <label>
          ...
          <div class="tab-content">
            <div id="one" class="tab-pane active">
              ...
              <div class="intro-detail">
                <img src="@/assets/detail/intro01.png" alt="intro01">
                <img src="@/assets/detail/intro02.png" alt="intro02">
                <img src="@/assets/detail/intro03.png" alt="intro03">
              </div>
            </div>
