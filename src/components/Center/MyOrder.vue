  ...
  <div class="order-right">
    <div class="order-content">
            ...
            <tr>
              <th colspan="5">
                <span class="ordertitle">
                  ...
                  <span class="pull-right delete"><img src="@/assets/center/delete.png" alt="delete"></span>
                </span>
              </th>
            </tr>
          </thead>
            ...
            <tr v-for="(orderDetail, index) in order.orderDetailList" :key="orderDetail.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="orderDetail.imgUrl" alt="goods" style="width: 60px;">
      ...
      <div class="choose-order">
        <BasePagination @getPageNo="getPageNo" :page-no="page" :page-size="limit" :total="myOrder.total"/>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
      ...
      <ul class="like-list">
        <li class="likeItem">
          <div class="p-img">
            <img src="@/assets/center/itemlike01.png" alt="itemlike01">
          </div>
          <div class="attr">
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/assets/center/itemlike02.png" alt="itemlike02">
          </div>
          <div class="attr">
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/assets/center/itemlike03.png" alt="itemlike03">
          </div>
        ...
        <li class="likeItem">
          <div class="p-img">
            <img src="@/assets/center/itemlike04.png" alt="itemlike04">
          </div>
          <div class="attr">DELL戴尔Ins 15MR-7528SS 15英寸 银色 笔记本
          </div>
          <div class="price">
  ...
  methods: {
    async getMyOrderList() {
      try {
        ...
        console.log('getMyOrderList err:', err)
      }
    },
